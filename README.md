...
- Attribution: BRGSTTR (brgsttr.de)
- Commercial use: not permitted without prior written permission (info@brgsttr.de)
- No derivatives: no edits, adaptations, translations, or remixes without explicit written permission
